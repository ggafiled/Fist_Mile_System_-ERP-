<div>
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card ">
                <div class="card-header text-white bg-dark">{{ __('USER MANAGEMENT') }}<span class="ml-3 ml-xs-auto text-black-50 text-white">{{ $role_count }} {{ __('Roles') }}</span>
                    <span text-white bg-dark class="ml-3 ml-xs-auto text-black-50 text-white"> </span></div>

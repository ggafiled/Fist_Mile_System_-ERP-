...
@section('content')
    <style>
        ...
        #loader {
            ...
            border-right: 16px solid rgb(4, 0, 255);
            border-radius: 50%;
            border-bottom: 16px solid rgb(255, 255, 255);
            border-left: 16px solid rgb(4, 0, 255);
    ...
    <body onload="myFunction()" style="margin:0;">
        <div id="loader"></div>
        <h3>{{ __('REPORT TOT TABLE') }}</h3>
        <div style="display:none;" id="myDiv" class="row justify-content-center">
            <div class="col-md">
                <div class="card">
                    <div class="card-header text-white bg-dark">{{ __('REPORT TOT TABLE') }}
                        </center>
                    </div>
                    <div class="card-body">
